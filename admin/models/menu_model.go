...
type MenuModel struct {
	...
	Banners      []BannerModel `gorm:"many2many:menu_banner;jsonForeignKey:MenuID;JoinReferences:BannerID" json:"banners"` //菜单的图片列表
	BannerTime   int           `json:"banner-time"`                                                                        //菜单图片的切换时间 为 0 表示不切换
